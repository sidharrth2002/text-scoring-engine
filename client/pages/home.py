...
def app():
    ...
    st.markdown("I contemplated using React or a more powerful frontend, but eventually settled on Streamlit because it got the job done the fastest.")
    st.markdown("""
                ...
                The final framework is below.
                """)
    st.image("images/updated-framework.png", width=800)
    st.markdown("""
                ...
                """)
    st.markdown("The dashboard is connected to a FastAPI backend.")
    st.markdown("""
        ### The Paper Abstract
